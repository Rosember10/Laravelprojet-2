        ...
        <div class="tab-content" id="pills-tabContent">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center mt-2">
                            <h1 class="display-one text-primary">Ajouter un article</h1>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="control-group col-12">
                                        ...
                                        <textarea id="content_fr" name="content_fr" class="form-control" rows="5" cols="30" > </textarea>
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center mt-2">
                            <h1 class="display-one text-primary">Add an Article</h1>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="control-group col-12">
                                        <label for="title" class="text-secondary">Title of article</label>
                                    ...
                                    <div class="control-group col-12">
                                        ...
                                        <textarea id="content" name="content" class="form-control" rows="5" cols="30"> </textarea>
